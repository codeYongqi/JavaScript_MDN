...
function result() {
    ...
    xItem=randomValueFromArray(insertX.split(','));
    yItem=randomValueFromArray(insertY.split(','));
    zItem=randomValueFromArray(insertZ.split(','));
    ...
    if(document.getElementById("american").checked) {
        ...
        let weight = Math.round(130*2.2046)+' 磅';
